    ...
    <div className="flex_col_wrapper">
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <img src={other_projects_image_1} alt="Maarcfit" class="project_details_image_other_projects--fullWidth box_shadow"></img>
            ...
            <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <img src={other_projects_image_2} alt="The Kraken" class="project_details_image_other_projects--fullWidth box_shadow"></img>
            ...
            <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <img src={other_projects_image_4} alt="The People's Republic of Cork" class="project_details_image_other_projects--fullWidth box_shadow"></img>
        ...
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <img src={other_projects_image_6} alt="Grant Me Safety" class="project_details_image_other_projects--fullWidth box_shadow"></img>
        ...
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <img src={other_projects_image_5} alt="Frog" class="project_details_image_other_projects--fullWidth box_shadow"></img>
        ...
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <img src={other_projects_image_3} alt="Disco Beat" class="project_details_image_other_projects--fullWidth box_shadow"></img>
        ...
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                <img src={other_projects_image_7} alt="Music On The Move" class="project_details_image_other_projects--fullWidth box_shadow"></img>
