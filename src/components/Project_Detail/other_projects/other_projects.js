    ...
    <div className="flex_col_wrapper">
        <div class="project_details_flex_col">
            ...
            <div class="project_details_text_wrapper ">
                ...
                <p className="project_details_body_text">Here I used an old octopus sketch typically found in historical books highlighting the dangers of seafaring as my reference. I used illustrator to draw out my own version with some depth effects and lighting to make the design appear 20,000 leagues below the sea.</p>
            </div>
            {/*<!--end of text wrapper-->*/}
        </div>{/*<!--END OF ROW-->*/}
            <div class="project_details_flex_col">
            ...
            <div class="project_details_text_wrapper ">
                ...
                <br></br>
                <br></br>
                <img src={other_projects_image_5} alt="Frog" class="project_details_image--fullWidth"></img>
                <p className="project_details_body_text">Originally this design began as a quick sketch that was later turned into a printed T-Shirt. Years later I updated the design to a vector format using illustrator. </p>
            </div>
            {/*<!--end of text wrapper-->*/}
        </div>{/*<!--END OF ROW-->*/}
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                ...
                <br></br>
                <br></br>
                <img src={other_projects_image_6} alt="Grant Me Safety" class="project_details_image--fullWidth"></img>
        ...
        <div class="project_details_flex_col">
            <div class="project_details_text_wrapper ">
                ...
                <br></br>
                <br></br>
                <img src={other_projects_image_7} alt="Music On The Move" class="project_details_image--fullWidth"></img>
                <p className="project_details_body_text">For this personal piece I aimed to convey the movement of music as a visualized wave of color that only the user can experience.</p>
            </div>
            {/*<!--end of text wrapper-->*/}
        </div>{/*<!--END OF ROW-->*/}
