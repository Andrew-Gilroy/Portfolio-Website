...
const Layout = ({ children, pageTitle }) => {
  ...
  //Updates state with current document title. This is used to conditionally render a different navbar
  useEffect(() => {
      ...
      return (
        <>
            ...
            <header>
                ...
                <nav>
                    {/* <i className="fas fa-bars" id="nav_hamburger" onClick={"openNav()"}></i> */}
                    ...
                    {/* <Link to="#about" className="nav_home_link">ABOUT</Link> */}
                    {/* <Link to="#projects" className="nav_home_link">PROJECTS</Link>
                    <Link to="#contact" className="nav_home_link">CONTACT</Link> */}
                </nav>
            </header>
          <main>{children}</main>
          </>
